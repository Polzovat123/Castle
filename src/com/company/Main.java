...
public class Main {
    ...
    public static String[] Lord = new String[10];
    public static int nowLord =0;
    ...
    public static void show_info_castle(){
        ...
        System.out.print("Популярность :");System.out.println(populate);
        module_speak();
    }
    ...
    public static void module_speak() {
        ...
        System.out.println("Посмотреть запросы черни милорд?");
        ...
        if (answer.equals("поговорить")){
            System.out.println(Lord[nowLord]+":/Приветсвую я готов повести ваши армии");
        }
    ...
    public static void end_batle(){
        Random st = new Random();
        int a = st.nextInt()+1;
        if(a==0){
            System.out.println(Lord[nowLord]+"<-------------------->Наше войско вернулось с победой и с добычей, ура нашей армии!!!<----------------->");
            fun();
            warior+=solder;
            solder=0;
            gold+=100;
            ...
            System.out.println("<-------------------->Наше войско разбито, полководец погиб, позор нашей армии!!!<----------------->");
            fun();
            solder=0;
            Lord[nowLord]="";
            populate-=40;
    ...
    public static void check_wariro(){
        ...
        if (warior>=10&& time ==0){
            ...
            try {
                ...
                System.out.println("Войско осталось дома, потребление такое же.");
            }
            //show_maps();
        }
    ...
    public static void my_peasant(){
        if (farmer+warior>=10+k){
            System.out.println("Ваше население растет и вам необходим новый лорд, купить или взть из солдат?(Купить== -10 золото) ");
            String a;
            Scanner in = new Scanner(System.in);
            a = in.next();
            if (a.equals("Купить")){
                populate-=10;
                gold-=10;
                Lord[nowLord]="Витылий";
                nowLord++;
            }else{
                warior--;
                if (populate+10<100)populate++;
                Lord[nowLord]="Витылий";
                nowLord++;
            }
        }
